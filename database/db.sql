...
-- );
-- CREATE TABLE Modelo_Anio (
--     id_modelo_anio INT IDENTITY(1,1) PRIMARY KEY,
...
--     id_modelo_anio INT NOT NULL,

--     PRIMARY KEY (id_producto, id_modelo_anio),
--     FOREIGN KEY (id_producto) REFERENCES Producto(id_producto),
--     FOREIGN KEY (id_modelo_anio) REFERENCES Modelo_Anio(id_modelo_anio)
-- );
